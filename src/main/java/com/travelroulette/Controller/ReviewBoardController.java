...
import com.travelroulette.Service.Board.Review.*;
...
public class ReviewBoardController extends HttpServlet {
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //작업 분기
        if (command.equals("/Board/Review/list.do")) {
            System.out.println("여행후기 게시판 목록 요청 처리");
        ...
        else if (command.equals("/Board/Review/write.do")) {
            System.out.println("글쓰기 요청 처리");

            ReviewBoardWriteService service = new ReviewBoardWriteService();
        ...
        else if (command.equals("/Board/Review/detail.do")) {
            System.out.println("상세보기 요청 처리");

            ReviewBoardDetailService service = new ReviewBoardDetailService();
        ...
        else if (command.equals("/Board/Review/update.do")) {
            System.out.println("글 수정 요청 처리");

            //글 수정 서비스 객체 생성 및 실행
            ReviewBoardUpdateService service = new ReviewBoardUpdateService();
        ...
        else if (command.equals("/Board/Review/delete.do")) {
            System.out.println("글 삭제 요청 처리");

            ReviewBoardDeleteService service = new ReviewBoardDeleteService();
            int result = service.execute(request, response);
        ...
        else if (command.equals("/Board/Review/comments.do")) {
            System.out.println("댓글 목록 요청 처리(비동기)");

            ReviewCommentListService service = new ReviewCommentListService();
        ...
        else if (command.equals("/Board/Review/comment/write.do")) {
            System.out.println("댓글 쓰기 요청 처리");

            ReviewCommentWriteService service = new ReviewCommentWriteService();
            int result = service.execute(request, response);
        ...
        else if (command.equals("/Board/Review/comment/update.do")) {
            System.out.println("댓글 수정 요청 처리(비동기)");

            ReviewCommentUpdateService service = new ReviewCommentUpdateService();
            int result = service.execute(request, response);
        ...
        else if (command.equals("/Board/Review/comment/delete.do")) {
            System.out.println("댓글 삭제 요청 처리(비동기)");

            ReviewCommentDeleteService service = new ReviewCommentDeleteService();
            int result = service.execute(request, response);
