...
#add-column-btn:hover { background: #0056b3; }
...
.delete-column-btn:hover { color: #e74c3c; }

.card-list { min-height: 60px; flex-grow: 1; }
...
@media (max-width: 1200px) { .column { flex: 1 1 calc(33.333% - 15px); } }
@media (max-width: 900px)  { .column { flex: 1 1 calc(50% - 15px); } }
@media (max-width: 600px)  { .column { flex: 1 1 calc(100% - 15px); } }
</style>
