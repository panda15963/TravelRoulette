...
(function() {
    ...
    const localId = document.getElementById('userId'); //목록이 들어갈 <tbody>
    const localPw = document.getElementById('userPassword'); //글 개수
    const localName = document.getElementById('name'); //검색 입력
    const localAddr = document.getElementById('address'); //정렬 select
    const localEmail = document.getElementById('email'); //지우기 버튼
    const localGender = document.getElementsByClassName('radio-group'); //글쓰기 버튼
